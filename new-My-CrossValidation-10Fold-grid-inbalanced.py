from sklearn.model_selection import StratifiedKFold, train_test_split, cross_val_score, KFold, RandomizedSearchCV, GridSearchCV
...
import os
os.environ['JOBLIB_TEMP_FOLDER'] = '/home/khukhas/temp/' # altera a localização de ficheiros temporários
...
output_file_path = sys.argv[2] + "/my_inbalanced_grid.txt"
#output_file_path = sys.argv[2] + "/my_over_grid.txt"
#output_file_path = sys.argv[2] + "/my_under_grid.txt"
#output_file_path = sys.argv[2] + "/my_hybrid_grid.txt"
...
if __name__ == "__main__":
    ...
    email_subject = (f"Script Completion Notification - My 10-Fold Cross Validation (Imbalaced) - Grid Search - {save_directory}")
    #email_subject = (f"Script Completion Notification - My 10-Fold Cross Validation (Over) - Grid Search - {save_directory}")
    #email_subject = (f"Script Completion Notification - My 10-Fold Cross Validation (Under) - Grid Search - {save_directory}")
    #email_subject = (f"Script Completion Notification - My 10-Fold Cross Validation (Hybrid) - Grid Search - {save_directory}")
    ...
    # Apply undersampling to the entire dataset before GridSearchCV
...
#        n_jobs=-1     Teve de ser reduzido para não ficar sem espaço em disco por causa de ficheiros temporários.
    ...
    # Run GridSearchCV on the undersampled training set
