...
#output_file_path = sys.argv[2] + "/lightgbm_inbalanced_nohyper.txt"
output_file_path = sys.argv[2] + "/lightgbm_over_nohyper.txt"
#output_file_path = sys.argv[2] + "/lightgbm_under_nohyper.txt"
#output_file_path = sys.argv[2] + "/lightgbm_hybrid_nohyper.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Imbalaced) - NoHyper - {save_directory}")
    email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Over) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Under) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Hybrid) - NoHyper - {save_directory}")
    ...
    # Evaluate model
    performance_metrics = evaluate_model(X, y)
