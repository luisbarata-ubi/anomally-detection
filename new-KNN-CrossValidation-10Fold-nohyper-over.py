...
#output_file_path = sys.argv[2] + "/knn_inbalanced_nohyper.txt"
output_file_path = sys.argv[2] + "/knn_over_nohyper.txt"
#output_file_path = sys.argv[2] + "/knn_under_nohyper.txt"
#output_file_path = sys.argv[2] + "/knn_hybrid_nohyper.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - KNN 10-Fold Cross Validation (Imbalaced) - NoHyper - {save_directory}")
    email_subject = (f"Script Completion Notification - KNN 10-Fold Cross Validation (Over) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - KNN 10-Fold Cross Validation (Under) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - KNN 10-Fold Cross Validation (Hybrid) - NoHyper - {save_directory}")
    ...
    # ------------------------------------------------------
    # Here we define a fixed set of KNN hyperparameters (no search).
    # You can change n_neighbors, weights, p, etc., as you see fit.
    # ------------------------------------------------------
    params = {
        'n_neighbors': 5,
        'weights': 'uniform',
    ...
    # Evaluate the model once using the fixed parameters
    fixed_metrics = evaluate_model(params, X, y)

    # Print the results
    print("Fixed Parameters:", params)
    print("Performance Metrics:", fixed_metrics)
