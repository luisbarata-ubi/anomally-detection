...
#output_file_path = sys.argv[2] + "/dt_inbalanced_nohyper.txt"
output_file_path = sys.argv[2] + "/dt_over_nohyper.txt"
#output_file_path = sys.argv[2] + "/dt_under_nohyper.txt"
#output_file_path = sys.argv[2] + "/dt_hybrid_nohyper.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Imbalaced) - noHyper - {save_directory}")
    email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Over) - noHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Under) - noHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Hybrid) - noHyper - {save_directory}")
    ...
    # ------------------------
    # Use a *fixed* set of parameters here (no optimization).
