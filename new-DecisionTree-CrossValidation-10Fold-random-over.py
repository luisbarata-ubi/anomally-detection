...
def evaluate_model(params, X, y):
    # Instantiate a DecisionTreeClassifier with the parameters
    ...
    # Include one example confusion matrix
...
def random_search(param_space, n_iter, X, y):
    ...
    for i in range(n_iter):
        ...
        # Use the metric of interest to track best parameters
...
#output_file_path = sys.argv[2] + "/dt_inbalanced_random.txt"
output_file_path = sys.argv[2] + "/dt_over_random.txt"
#output_file_path = sys.argv[2] + "/dt_under_random.txt"
#output_file_path = sys.argv[2] + "/dt_hybrid_random.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Imbalaced) - Random - {save_directory}")
    email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Over) - Random - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Under) - Random - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Hybrid) - Random - {save_directory}")
