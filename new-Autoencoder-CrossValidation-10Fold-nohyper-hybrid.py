...
def evaluate_autoencoder(X, y, encoder, encoding_dim=16):
...
#output_file_path = sys.argv[2] + "/autoencoder_inbalanced_nohyper.txt"
#output_file_path = sys.argv[2] + "/autoencoder_over_nohyper.txt"
#output_file_path = sys.argv[2] + "/autoencoder_under_nohyper.txt"
output_file_path = sys.argv[2] + "/autoencoder_hybrid_nohyper.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - Autoencoder 10-Fold Cross Validation (Imbalaced) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - Autoencoder 10-Fold Cross Validation (Over) - NoHyper - {save_directory}")
    #email_subject = (f"Script Completion Notification - Autoencoder 10-Fold Cross Validation (Under) - NoHyper - {save_directory}")
    email_subject = (f"Script Completion Notification - Autoencoder 10-Fold Cross Validation (Hybrid) - NoHyper - {save_directory}")
    ...
    metrics = evaluate_autoencoder(X, y, None)
