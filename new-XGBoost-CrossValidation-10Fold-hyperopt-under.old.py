...
#output_file_path = sys.argv[2] + "/xgboost_inbalanced_hyperopt.txt"
#output_file_path = sys.argv[2] + "/xgboost_over_hyperopt.txt"
output_file_path = sys.argv[2] + "/xgboost_under_hyperopt.txt"
#output_file_path = sys.argv[2] + "/xgboost_hybrid_hyperopt.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Imbalaced) - HyperOPT - {save_directory}")
    #email_subject = (f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Over) - HyperOPT - {save_directory}")
    email_subject = (f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Under) - HyperOPT - {save_directory}")
    #email_subject = (f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Hybrid) - HyperOPT - {save_directory}")
