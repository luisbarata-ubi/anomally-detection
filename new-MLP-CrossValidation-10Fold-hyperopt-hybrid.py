...
def objective(params):
    mlp_model = MLPClassifier(
        hidden_layer_sizes=tuple(map(int, params['hidden_layer_sizes'])),
...
#output_file_path = sys.argv[2] + "/mlp_inbalanced_hyperopt.txt"
#output_file_path = sys.argv[2] + "/mlp_over_hyperopt.txt"
#output_file_path = sys.argv[2] + "/mlp_under_hyperopt.txt"
output_file_path = sys.argv[2] + "/mlp_hybrid_hyperopt.txt"
...
if __name__ == "__main__":
    ...
    #email_subject = (f"Script Completion Notification - MLP 10-Fold Cross Validation (Imbalaced) - HyperOPT - {save_directory}")
    #email_subject = (f"Script Completion Notification - MLP 10-Fold Cross Validation (Over) - HyperOPT - {save_directory}")
    #email_subject = (f"Script Completion Notification - MLP 10-Fold Cross Validation (Under) - HyperOPT - {save_directory}")
    email_subject = (f"Script Completion Notification - MLP 10-Fold Cross Validation (Hybrid) - HyperOPT - {save_directory}")
