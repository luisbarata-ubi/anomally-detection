...
output_file_path = sys.argv[2] + "/dt_inbalanced_grid.txt"
#output_file_path = sys.argv[2] + "/dt_over_grid.txt"
#output_file_path = sys.argv[2] + "/dt_under_grid.txt"
#output_file_path = sys.argv[2] + "/dt_hybrid_grid.txt"
...
if __name__ == "__main__":
    ...
    email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Imbalaced) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Over) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Under) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - Decision Tree 10-Fold Cross Validation (Hybrid) - Grid - {save_directory}")
    ...
    # Example for a grid search with Decision Trees
    param_grid = {
