...
def grid_search(param_grid, X, y):
    """
    Iterates over all values of var_smoothing in 'param_grid' using the
    evaluate_model function, and returns the best combination by F1 score.
    """
    # Assuming param_grid is a dict like:
    ...
    for i, vs in enumerate(var_smoothing_values):
        ...
        print(f"Combination {i+1}/{len(var_smoothing_values)}, "
              f"Params: {params}, "
...
output_file_path = sys.argv[2] + "/gaussian_inbalanced_grid.txt"
#output_file_path = sys.argv[2] + "/gaussian_over_grid.txt"
#output_file_path = sys.argv[2] + "/gaussian_under_grid.txt"
#output_file_path = sys.argv[2] + "/gaussian_hybrid_grid.txt"
...
if __name__ == "__main__":
    ...
    email_subject = (f"Script Completion Notification - GaussianNB 10-Fold Cross Validation (Imbalaced) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - GaussianNB 10-Fold Cross Validation (Over) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - GaussianNB 10-Fold Cross Validation (Under) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - GaussianNB 10-Fold Cross Validation (Hybrid) - Grid - {save_directory}")
    ...
    # Example for a grid search with GaussianNB
    param_grid = {
        'var_smoothing': [1e-9, 1e-8, 1e-7, 1e-6, 1e-5]
    }
