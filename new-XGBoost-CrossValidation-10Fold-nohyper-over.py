...
# output_file_path = sys.argv[2] + "/xgboost_inbalanced_nohyper.txt"
output_file_path = sys.argv[2] + "/xgboost_over_nohyper.txt"
# output_file_path = sys.argv[2] + "/xgboost_under_nohyper.txt"
# output_file_path = sys.argv[2] + "/xgboost_hybrid_nohyper.txt"
...
if __name__ == "__main__":
    ...
    # Set email details
    #email_subject = f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Imbalaced) - NoHyper - {save_directory}"
    email_subject = f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Oversampling) - NoHyper - {save_directory}"
    #email_subject = f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Undersampling) - NoHyper - {save_directory}"
    #email_subject = f"Script Completion Notification - XGBoost 10-Fold Cross Validation (Hybridsampling) - NoHyper - {save_directory}"
