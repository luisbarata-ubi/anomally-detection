...
output_file_path = sys.argv[2] + "/lightgbm_inbalanced_grid.txt"
#output_file_path = sys.argv[2] + "/lightgbm_over_grid.txt"
#output_file_path = sys.argv[2] + "/lightgbm_under_grid.txt"
#output_file_path = sys.argv[2] + "/lightgbm_hybrid_grid.txt"
...
if __name__ == "__main__":
    ...
    email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Imbalaced) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Over) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Under) - Grid - {save_directory}")
    #email_subject = (f"Script Completion Notification - LightGBM 10-Fold Cross Validation (Hybrid) - Grid - {save_directory}")
    ...
    #best_params = random_search(param_space, n_iter, X, y)
